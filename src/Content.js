                        ...
                        <Paper style={{ borderRadius: "5px", width: "100%", marginTop: "50px", minHeight: "520px", border: "2px solid darkred" }}>
                            <Grid container>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    value={data["kt1"]}
                                    placeholder="None"
                                    onChange={(e)=> updateScore(0, "kt1", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    placeholder="None"
                                    onChange={(e) => updateScore(1, "kt2", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    value={data["kt3"]}
                                    placeholder="None"
                                    onChange={(e) => updateScore(2, "kt3", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    value={data["lms"]}
                                    placeholder="None"
                                    onChange={(e) => updateScore(3, "lms", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                <Grid item xs={3}></Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    onChange={(e) => updateScore(4, "kt4", Number(e.target.value))}
                                ...
                                <Grid item xs={2}>
                                    ...
                                    value={data["kt5"]}
                                    placeholder="None"
                                    onChange={(e) => updateScore(5, "kt5", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    value={data["kt6"]}
                                    placeholder="None"
                                    onChange={(e) => updateScore(6, "kt6", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    placeholder="None"
                                    onChange={(e) => updateScore(7, "thao_luan", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                ...
                                <Grid item xs={2}>
                                    ...
                                    placeholder="None"
                                    onChange={(e) => updateScore(8, "final_test", Number(e.target.value))}
                                    ></input>
                                </Grid>
                                <Grid item xs={1}></Grid>
